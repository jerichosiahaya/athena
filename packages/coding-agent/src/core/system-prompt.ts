...
export function buildSystemPrompt(options: BuildSystemPromptOptions): string {
	...
	let prompt = `You are ${APP_NAME}, an expert coding assistant operating inside ${APP_NAME}, a coding agent harness (a fork of the open-source pi harness). You help users by reading files, executing commands, editing code, and writing new files.
